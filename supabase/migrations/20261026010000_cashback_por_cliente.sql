...
-- ser AMBÍGUA — erro em tempo de execução para quem já chama assim, que são
-- `ComercialCashback.tsx` (a tela de cashback, por três hooks), a própria
-- `com_cashback_indicadores` e as asserções do pgTAP. Por isso o `drop`
-- explícito antes — mesma armadilha e mesma solução de `20261016020000`
-- (item 4) e `20261001020000`.
--
