  ...
  return (
    <Routes>
      ...
      {/* Frente 6 (.scratch/plano-frente6-importacoes.md §3): DIFERENTE das
          ...
          Quem tem `vendas.importar`, `vendas.substituir` ou `metas.definir`
          entra mesmo sem ser dono/admin; a tela mostra os três cartões e só
          habilita o que a permissão da pessoa cobre (regra 2 das cinco, do
          lado da tela: nunca um botão que responde com erro depois do clique). */}
