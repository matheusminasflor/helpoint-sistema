...
import { useAnosComVenda } from '@/hooks/useComercialPainel';
...
export default function ComercialCashback() {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      {/* Indicadores — os quatro números do topo (§12), somados no banco. */}
          ...
          <tbody>
            {comDireito.map((c) => (
              <tr key={c.cliente_codigo} className="border-t border-border">
                ...
                <td className="px-3 py-1.5 text-muted-foreground">{c.tabela_base ?? '—'}</td>
