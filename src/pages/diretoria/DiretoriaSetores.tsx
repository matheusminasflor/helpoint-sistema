// Visão "Setores" da Diretoria (Frente 3, item 4.7 do plano) — os
// objetivos da empresa e os chamados por setor. Era a abertura do painel
// ("Visão geral") antes desta leva; o dono nunca mencionou isso como
// abertura — o §14 do documento dele abre em metas e histórico. Sai da
// abertura, não sai do sistema: continua alcançável pelo menu.
...
export default function DiretoriaSetores() {
  ...
  return (
    <div className="flex flex-col h-full">
      <PageHeader
        icon={Building2}
        title="Setores"
        description="Os objetivos da empresa e como cada setor está respondendo."
      />
