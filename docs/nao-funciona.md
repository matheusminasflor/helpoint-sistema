...
- Cobertura de teste: 47 testes no front (Vitest) — SLA em `src/types/helpdesk.test.ts`, rotas
  ...
  14 sobre a base do CRM, 16 sobre funis editáveis, 25 sobre segmentos, tabelas de preço e portões, 12 sobre pedido e proposta, 13 sobre campos
  personalizados, 13 sobre importação de planilha e 9 sobre indicadores de
  venda — **210**. O CI os roda contra um banco do zero a cada push ao
